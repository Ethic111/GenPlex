		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				<div class="d-flex justify-content-between mb-2">
					...
					<a href="addCity"><button class="btn btn-primary mt-2"
										...
										<tbody>
											<c:forEach items="${cityList}" var="i" varStatus="j">
												<tr>
													...
													<td class="text-wrap">
													<c:choose>
															<c:when test="${not empty i.cityDescription}">
															${i.cityDescription}
														</c:when>
															<c:otherwise>
															---
													...
													<td><a href="deleteCity?id=${i.id}"><i
															class="mdi mdi-delete-sweep"
															style="color: red; font-size: 1.5rem;"></i></a> <a
														href="editCity?id=${i.id}" style="margin-left: 1rem;"><i
