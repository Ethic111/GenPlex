...
<body>
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="row mb-3">
					<h3 class="page-title">Add Degree</h3>


				</div>
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="#">Manage Degree</a></li>
					...
					<div class="col-lg-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<f:form action="saveDegree" method="post"
									modelAttribute="DegreeVo" id="addDegreeForm">
									<div>

										<div class="mb-3">
											<label for="degreename" class="form-label">Degree<i
												class="text-danger">*</i></label>
											<f:input class="form-control" name="degreeName"
												id="degreename" path="degreeName" />
										</div>
	...
	<script src="<%=request.getContextPath()%>/adminresources/js/custom/degree.js"></script>
</body>
</html>
