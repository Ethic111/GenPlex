...
<title>Admin | Add Report Type</title>
...
<body>
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="row mb-3">
					<h3 class="page-title">Add Report Types</h3>


				</div>
				<nav class="page-breadcrumb">
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="#">Manage Report Types</a></li>
					...
					<div class="col-lg-12 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<f:form action="saveReportType" method="post"
									modelAttribute="ReportTypeVo" id="addReportTypeForm">
									<div>

										<div class="mb-3">
											<label for="reportTypename" class="form-label">Report Type<i
												class="text-danger">*</i></label>
											<f:input class="form-control" name="reportTypeName"
												id="reportTypename" path="reportTypeName" />
										</div>
	...
	<script
		src="<%=request.getContextPath()%>/adminresources/js/custom/degree.js"></script>
</body>
</html>
