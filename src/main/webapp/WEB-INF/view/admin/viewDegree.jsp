		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<div class="d-flex justify-content-between mb-2">
					...
					<div>
						<div class="row mb-3">
							<h3 class="page-title">Degrees</h3>
						</div>
					...
					<a href="addDegree"><button class="btn btn-primary mt-2"
										...
										<tbody>
											<c:forEach items="${degreeList}" var="i" varStatus="j">
												<tr>
													<td>${j.count}</td>
													<td>${i.degreeName}</td>
													<td><a href="deleteDegree?id=${i.id}"><i
															class="mdi mdi-delete-sweep"
															style="color: red; font-size: 1.5rem;"></i></a> <a
														href="editDegree?id=${i.id}" style="margin-left: 1rem;"><i
