...
<body>
		...
		<div class="page-wrapper">
			...
			<div class="page-content">
				...
				<input type="hidden" id="barChartData" value="${barChartData}" /> <input
					type="hidden" id="pieChartLabels" value="${pieChartLabels}" /> <input
					type="hidden" id="pieChartData" value="${pieChartData}" />
				<!-- row -->
								...
								<div class="card">
									<div class="card-body">
										<div
											...
											<h6 class="card-title mb-0">Doctors Consulted</h6>
											<div class="dropdown mb-2"></div>
										</div>
										<div class="row">
											<div class="col-6 col-md-12 col-xl-5">
												<h3 class="mb-2">${doctorCount}</h3>
				...
				<div class="mb-5">
					<div class="row">
						...
						<div class="col-6">
							<div class="card">
								<div class="card-body">
									<h6 class="card-title">Doctor-Report Bar chart</h6>
	...
	<!-- Custom js for this page -->
	<script
		src="<%=request.getContextPath()%>/adminresources/js/custom/patientIndexChart.js"></script>
	<!-- End custom js for this page -->
</body>
</html>
