$(document).ready(function() {
 ...
 // Event listener for the view link
    ...
    $("#patientdoctor_select").on('change', (selectElement) => {
...
function ajaxfunc(cityStateValue, patientDoctor, reportType) {
    $.ajax({
        url: `http://localhost:7072/filterReports?cityState=${cityStateValue}&patientDoctor=${patientDoctor}&reportType=${reportType}`,
        method: 'GET',
