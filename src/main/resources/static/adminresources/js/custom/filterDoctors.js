...
function updateTableOnSelect(data, table, reviewStatus) {
    ...
    data.forEach((item, index) => {
        ...
        if (reviewStatus === 'ACCEPTED') {
            ...
            row.push(`<a class="download-link" href="#" data-file-path="${i.certificatePath}"><i class="mdi mdi-download" style="color: blue; font-size: 1.5rem;"></i></a>`)
            row.push(`<a class="download-link" href="#" data-file-path="${i.addressProofPath}><i class="mdi mdi-download" style="color: blue; font-size: 1.5rem;"></i></a>`)
            row.push(`<a class="download-link" href="#" data-file-path="${i.governmentIdPath}><i class="mdi mdi-download" style="color: blue; font-size: 1.5rem;"></i></a>`)
        }
    ...
    const columnHeaders = [
        ...
        'DEGREE'
       ,
		 * 'CERTIFICATE', 'ADDRESS PROOF', 'GOVERNMENT ID'
